...
?>
<nav class="admin-pagination" style="display:flex;gap:.35rem;flex-wrap:wrap;justify-content:center;margin-top:1.25rem;">
  <?php foreach ($pagination->getLinks() as $link): ?>
    ...
    <?php else: ?>
      <span class="btn btn-sm" style="opacity:.5;cursor:default;"><?= e($link['label']) ?></span>
    <?php endif; ?>
  <?php endforeach; ?>
</nav>
